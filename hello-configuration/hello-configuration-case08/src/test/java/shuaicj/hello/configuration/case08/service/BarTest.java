package shuaicj.hello.configuration.case08.service;
...
import shuaicj.hello.configuration.case08.bean.A;
...
public class BarTest {
     ...
     * The difference with case07 is that method names are overrideB() and overrideFoo().
     */
    @Configuration
    static class Config {
