package shuaicj.hello.configuration.case11.service;
...
import shuaicj.hello.configuration.case11.Application;
import shuaicj.hello.configuration.case11.config.OverrideB;
import shuaicj.hello.configuration.case11.config.OverrideFoo;
...
public class BarTest {
     ...
     * The override-B is declared in method b() (annotated by @Bean) in class OverrideB (annotated by @Configuration,
     ...
     * The override-Foo is declared in method foo() (annotated by @Bean) in class OverrideFoo (annotated by @Configuration,
     * and specified by @SpringBootTest).
     *
