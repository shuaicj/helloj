package shuaicj.hello.persist.jpa.relationship;
...
import shuaicj.hello.persist.jpa.relationship.entity.Employee;
import shuaicj.hello.persist.jpa.relationship.entity.IdentityCard;
import shuaicj.hello.persist.jpa.relationship.entity.Phone;
import shuaicj.hello.persist.jpa.relationship.entity.Project;
import shuaicj.hello.persist.jpa.relationship.repo.EmployeeRepository;
import shuaicj.hello.persist.jpa.relationship.repo.IdentityCardRepository;
import shuaicj.hello.persist.jpa.relationship.repo.PhoneRepository;
import shuaicj.hello.persist.jpa.relationship.repo.ProjectRepository;
...
public class RelationshipTest {
    ...
    @Autowired IdentityCardRepository identityCardRepo;
    @Autowired PhoneRepository phoneRepo;
